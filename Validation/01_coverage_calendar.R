...
#   Santos, the summer rainy season routinely removes entire months from the
...
#      of the city.
#   4. Flags July 2021 separately (known Landsat-7 artefact, see 00_common.R).
...
p1 <- p1 +
  ...
  labs(
    ...
    caption = paste0(
      ...
      "Red marks July 2021, excluded from all downstream statistics ",
